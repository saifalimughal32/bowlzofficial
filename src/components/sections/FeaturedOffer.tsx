        ...
        <div className="mb-8 grid gap-4 md:grid-cols-3">
          {bundles.map((b, i) => (
            <AnimateIn key={b.qty} delay={(i + 1) as 1 | 2 | 3}>
              <div
                className={`relative rounded-[20px] bg-white p-8 text-center transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_8px_32px_rgba(138,44,77,0.1)] ${b.default ? "border-2 border-plum shadow-[0_8px_32px_rgba(138,44,77,0.1)]" : "border-2 border-transparent"}`}
              >
                {b.badge && (
                ...
                <div className="mb-2 font-heading text-xl text-plum">{b.qty} Belt{b.qty > 1 ? "s" : ""}</div>
