import { PAYMENT_METHODS } from "@/components/icons/PaymentMethodIcons";
...
export function TrustStrip({ compact = false }: { compact?: boolean }) {
  return (
    <div
      className={`flex flex-wrap items-center justify-center gap-x-5 gap-y-2 ${compact ? "text-xs" : "text-sm"} text-taupe-dark`}
    >
